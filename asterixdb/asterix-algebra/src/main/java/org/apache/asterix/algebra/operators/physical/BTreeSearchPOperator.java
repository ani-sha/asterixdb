...
public class BTreeSearchPOperator extends IndexSearchPOperator {
    ...
    public void contributeRuntimeOperator(IHyracksJobBuilder builder, JobGenContext context, ILogicalOperator op,
        ...
        Boolean isLeftMostBtree = false;
        if (op.getAnnotations().containsKey("Left_Most_Btree")) {
            if ((Boolean) op.getAnnotations().get("Left_Most_Btree") == true) {
                isLeftMostBtree = true;
            }
        }
        ...
        Pair<IOperatorDescriptor, AlgebricksPartitionConstraint> btreeSearch = metadataProvider.getBtreeSearchRuntime(
                ...
                isPrimaryIndexPointSearch(), context.getPhysicalOptimizationConfig().getInteractiveMode(),
                isLeftMostBtree);
    ...
    private boolean useBatchPointSearch(ILogicalOperator op, PhysicalOptimizationConfig config) {
        ...
        if (vector != null) {
            if (vector.getLocalProperties() != null) {
