...
public final class RuleCollections {
    ...
    public static List<IAlgebraicRewriteRule> prepareForJobGenRuleCollection(
        ...
        prepareForJobGenRewrites.add(new ReplaceSortBeforeINLJRule());
        prepareForJobGenRewrites.add(new ReplaceSortBeforePreClusteredGroupByRule());
        ...
        prepareForJobGenRewrites.add(new RewriteMultiColumnGroupByRule());
        //prepareForJobGenRewrites.add(new FixHashMergeExchangeForGroupByRule());
        //prepareForJobGenRewrites.add(new ReplaceSortGroupBywithPreClusteredGroupByRule());
        prepareForJobGenRewrites.add(new SetExecutionModeRule());
        prepareForJobGenRewrites.add(new SetExecutionModeForInteractiveModeRule());
