...
public class InteractiveJoinRule extends AbstractIntroduceAccessMethodRule {
    ...
    public boolean rewritePre(Mutable<ILogicalOperator> opRef, IOptimizationContext context)
        ...
        if (!CheckForAvailableIndex(opRef))
            return false;
        ...
        PlanSwitchOperator switchOperator =
                new PlanSwitchOperator(interactiveChildOperatorRef, hashJoinOperatorRef, condition);
    ...
    public List<Index> getAllIndexes(Dataset dataset) throws AlgebricksException {
        ...
        try {
            ...
            indexes = MetadataManager.INSTANCE.getDatasetIndexes(mdTxnCtx, dataset.getDatabaseName(),
