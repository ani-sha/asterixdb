...
class SubplanSpecialFlatteningCheckVisitor implements IQueryOperatorVisitor<Boolean, Void> {
    ...
    @Override
    public Boolean visitIncrementalOrderOperator(IncrementalOrderOperator op, Void arg) throws AlgebricksException {
        return visitInputs(op);
    }

    @Override
    public Boolean visitEagerMergeOperator(EagerMergeOperator op, Void arg) throws AlgebricksException {
        return visitInputs(op);
    }
