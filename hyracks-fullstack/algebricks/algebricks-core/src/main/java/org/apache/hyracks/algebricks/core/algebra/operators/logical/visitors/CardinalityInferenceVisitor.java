...
public class CardinalityInferenceVisitor implements ILogicalOperatorVisitor<Long, Void> {
    ...
    @Override
    public Long visitIncrementalOrderOperator(IncrementalOrderOperator incrementalOrderOperator, Void arg)
            throws AlgebricksException {
        return incrementalOrderOperator.getInputs().get(0).getValue().accept(this, arg);
    }

    @Override
    public Long visitEagerMergeOperator(EagerMergeOperator eagerMergeOperator, Void arg) throws AlgebricksException {
        return eagerMergeOperator.getInputs().get(0).getValue().accept(this, arg);
    }
