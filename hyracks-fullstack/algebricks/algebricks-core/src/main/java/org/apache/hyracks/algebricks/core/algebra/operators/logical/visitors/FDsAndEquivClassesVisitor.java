...
public class FDsAndEquivClassesVisitor implements ILogicalOperatorVisitor<Void, IOptimizationContext> {
    ...
    @Override
    public Void visitIncrementalOrderOperator(IncrementalOrderOperator op, IOptimizationContext ctx)
            throws AlgebricksException {
        propagateFDsAndEquivClasses(op, ctx);
        return null;
    }
    ...
    @Override
    public Void visitEagerMergeOperator(EagerMergeOperator eagerMergeOperator, IOptimizationContext arg)
            throws AlgebricksException {
        return null;
    }
}
