...
public class IsomorphismVariableMappingVisitor implements ILogicalOperatorVisitor<Void, ILogicalOperator> {
    ...
    @Override
    public Void visitIncrementalOrderOperator(IncrementalOrderOperator op, ILogicalOperator arg)
            throws AlgebricksException {
    ...
    @Override
    public Void visitEagerMergeOperator(EagerMergeOperator op, ILogicalOperator arg) throws AlgebricksException {
        mapVariablesStandard(op, arg);
        return null;
    }
