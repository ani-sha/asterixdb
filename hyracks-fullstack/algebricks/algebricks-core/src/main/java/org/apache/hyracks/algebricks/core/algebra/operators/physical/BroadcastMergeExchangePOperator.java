...
public class BroadcastMergeExchangePOperator extends AbstractExchangePOperator {

    private final INodeDomain domain;
    private final List<OrderColumn> orderColumns;

    public BroadcastMergeExchangePOperator(INodeDomain domain, List<OrderColumn> orderColumns) {
        this.domain = domain;
    ...
    public PhysicalOperatorTag getOperatorTag() {
        return PhysicalOperatorTag.BROADCAST_MERGE_EXCHANGE;
    }
