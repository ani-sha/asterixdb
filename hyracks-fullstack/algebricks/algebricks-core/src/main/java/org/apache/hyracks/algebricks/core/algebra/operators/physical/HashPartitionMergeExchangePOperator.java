...
import org.apache.hyracks.dataflow.std.connectors.MToNPartitioningMergingNonMaterializingConnectorDescriptor;
...
public class HashPartitionMergeExchangePOperator extends AbstractExchangePOperator {
    ...
    private boolean isMaterializationReqd = true;
    ...
    public HashPartitionMergeExchangePOperator(List<OrderColumn> orderColumns, List<LogicalVariable> partitionFields,
        ...
        this.domain = domain;
        this.partitionsMap = partitionsMap;
        this.isMaterializationReqd = isMaterializationReqd;
    }
