...
public interface ILogicalOperatorVisitor<R, T> {
    ...
    public R visitIncrementalOrderOperator(IncrementalOrderOperator incrementalOrderOperator, T arg)
            throws AlgebricksException;

    public R visitEagerMergeOperator(EagerMergeOperator eagerMergeOperator, T arg) throws AlgebricksException;
}
