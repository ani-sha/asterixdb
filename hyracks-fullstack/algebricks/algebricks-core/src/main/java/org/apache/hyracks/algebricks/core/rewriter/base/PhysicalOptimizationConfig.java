...
public class PhysicalOptimizationConfig {
    ...
    public boolean getInteractiveMode() {
        return getBoolean(INTERACTIVEMODE, AlgebricksConfig.INTERACTIVE_MODE_DEFAULT);
    }

    public void setInteractiveMode(boolean interactiveMode) {
        setBoolean(INTERACTIVEMODE, interactiveMode);
    }

    public boolean getBlockingMode() {
        return getBoolean(BLOCKINGMODE, AlgebricksConfig.BLOCKING_MODE_DEFAULT);
    }
