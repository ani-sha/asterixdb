...
public class InlineVariablesRule implements IAlgebraicRewriteRule {
    ...
    public static class InlineVariablesVisitor extends LogicalExpressionReferenceTransformVisitor
        ...
        @Override
        public Boolean visitIncrementalOrderOperator(IncrementalOrderOperator incrementalOrderOperator,
                ILogicalExpressionReferenceTransform arg) throws AlgebricksException {
            return null;
        }

        @Override
        public Boolean visitEagerMergeOperator(EagerMergeOperator eagerMergeOperator,
                ILogicalExpressionReferenceTransform arg) throws AlgebricksException {
            return null;
        }
