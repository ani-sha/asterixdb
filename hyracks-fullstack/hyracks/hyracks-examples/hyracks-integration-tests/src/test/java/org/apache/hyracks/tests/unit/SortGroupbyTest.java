    ...
    protected void initial(final IHyracksTaskContext ctx, int tableSize, final int numFrames)
        ...
        mergerOperator = new AbstractUnaryOutputSourceOperatorNodePushable() {
            ...
            public void initialize() throws HyracksDataException {
                ...
                try {
                    merger = new ExternalSortGroupByRunMerger(ctx, runs, keyFields, inRecordDesc, outputRec, outputRec,
                            numFrames, keyFields, nmkComputer, comparators, partialAggrInState, finalAggrInState, true);
                } catch (IOException e) {
